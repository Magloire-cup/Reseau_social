...
export default function HomePage() {
    ...
    async function submitAuth(event: FormEvent) {
        ...
        setAuthError("");
        if (!supabase) { setAuthError(t.demo); return; }
    ...
    async function sendMessage(event: FormEvent) {
        ...
        setIsSending(true);
        try {
            const answer = await askGemini(selectedId, nextMessages.map(message => ({ role: message.role, content: message.content })), language);
